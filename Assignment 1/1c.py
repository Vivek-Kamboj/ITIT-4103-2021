...
X, y = datasets.make_circles(200, noise=0, random_state=42)
X1, y1 = datasets.make_moons(200, noise=0, random_state=42)
X2, y2= datasets.make_blobs(200, random_state=42)
fig, ax = plt.subplots(nrows=1, ncols=3, figsize=(12, 7))
plt.xlabel("x0", fontsize=10)
plt.ylabel("y0", fontsize=10)
plt.subplot(1,3,1)
